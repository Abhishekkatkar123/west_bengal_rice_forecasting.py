...
def prediction(periods):
    rice2019 = pd.read_csv('Rice_2019.csv')
    rice2020 = pd.read_csv('Rice_2020.csv')
    rice2021 = pd.read_csv('Rice_2021.csv')
    rice2022 = pd.read_csv('Rice_2022.csv')
    rice2023 = pd.read_csv('Rice_2023.csv')
    rice2024 = pd.read_csv('Rice_2024.csv')
    ...
    West_Bengal = Rice[Rice['state'] == 'West Bengal']#only wb
    West_Bengal['arrival_date'] = pd.to_datetime(West_Bengal['arrival_date'], format='%d/%m/%Y')#formate change
